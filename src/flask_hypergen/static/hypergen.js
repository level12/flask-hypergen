...
(n,o):u.TEXTAREA(n,o))}(U,o,O),R)for(var P=0,D=R.length;P<D;P++){var M=L[R[P]];M&&x(M,M.parentNode,!1)}}return!O&&U!==e&&e.parentNode&&(U.actualize&&(U=U.actualize(e.ownerDocument||r)),// If we had to swap out the from node with a new node because the old
...
var D=0,M=!1,F={};let W=function(e,t,{debounce:n=0,confirm_:r=!1,blocks:l=!1,blocksEachUrl:i=!0,uploadFiles:a=!1,params:d={},meta:u={},clear:c=!1,elementId:s=null,debug:f=!1,event:p=null,headers:m={},onSucces:h=null,timeout:v=2e4,formId:g=null}={}){let y=e.startsWith("ws://")||e.startsWith("wss://");p&&(p.preventDefault(),p.stopPropagation());let E=y?function(){let r;console.log("WEBSOCKET",e,t,n);try{r=JSON.stringify({args:t,meta:u})}catch(t){if(t===Q){console.warn("An element is missing. This can happen if a dom element has multiple event handlers.",e);return}throw t}if(!o.websocket.WEBSOCKETS[e]){console.error("Cannot send WS to non existing connection:",e);return}o.websocket.WEBSOCKETS[e].send(r),!0===c&&(document.getElementById(s).value="")}:function(){let r;console.log("REQUEST",e,t,n),D++,// The element function must have access to the FormData.
o.hypergenGlobalFormdata=null===g?new FormData:new FormData(document.getElementById(g)),o.hypergenUploadFiles=a;try{r=JSON.stringify({args:t,meta:u})}catch(t){if(t===Q){console.warn("An element is missing. This can happen if a dom element has multiple event handlers.",e);return}throw t}let p=o.hypergenGlobalFormdata;if(o.hypergenGlobalFormdata=null,o.hypergenUploadFiles=null,p.append("hypergen_data",r),!0===l){if(!0===M){console.error("Callback was blocked");return}M=!0}if(!0===i&&!y){if(F[e]){console.error("Callback to "+e+" was blocked");return}F[e]=!0}el(e,p,t=>{null!==t&&z(t),M=!1,!0!==i||y||delete F[e],!0===c&&(document.getElementById(s).value=""),h&&h()},(t,n,o)=>{console.log("xhr:",o),M=!1,!0!==i||y||delete F[e],console.error("Hypergen post error occured",t),!0!==f&&("text/plain"===o.getResponseHeader("Content-Type")&&(t="<pre><code>"+t+"</pre></code>"),document.getElementsByTagName("html")[0].innerHTML=t)},d,m,{timeout:v})};0===n?!1===r?E():confirm(r)&&E():V(E,{delay:n,group:e,confirm_:r})},X=function(e,t,n){console.log("partialLoad to",t,n),window.dispatchEvent(new CustomEvent("hypergen.partialLoad.before",{detail:{event:e,url:t,pushState:n}})),W(t,[],{event:e,headers:{"X-Hypergen-Partial":"1"},onSucces:function(){n&&(console.log("pushing state!"),history.pushState({callback_url:t},"",t),ea(),history.forward(),window.dispatchEvent(new CustomEvent("hypergen.partialLoad.after",{detail:{event:e,url:t,pushState:n}})))}})};// Timing
